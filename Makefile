...
8ball: tty.c tty.h cpu.c cpu.h 8ball.c linenoise.c linenoise.h rimloader.h console.c console.h machine.c machine.h rx8.c rx8.h rxloader.h
...
8srv: 8ball.c machine.c machine.h tty.c tty.h cpu.c cpu.h rimloader.h serial_com.c serial_com.h rx8.c rx8.h
	$(CC) -Wall -W -g -o 8srv 8ball.c machine.c tty.c cpu.c serial_com.c rx8.c -DPTY_SRV -fmax-errors=1

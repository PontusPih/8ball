...
8ball: tty.c tty.h cpu.c cpu.h 8ball.c linenoise.c linenoise.h rimloader.h console.c console.h machine.c machine.h tty_cpu.c tty_cpu.h
	$(CC) -Wall -W -g -o 8ball tty.c cpu.c 8ball.c console.c machine.c linenoise.c tty_cpu.c -DSERVER_BUILD -fmax-errors=5 -Wno-unused-parameter

...
8con: 8ball.c frontend.c frontend.h linenoise.c console.h console.c machine.c machine.h serial_com.c serial_com.h serial_com_pty.c
	$(CC) -Wall -W -g -o 8con 8ball.c frontend.c linenoise.c console.c machine.c serial_com.c serial_com_pty.c -DPTY_CLI=\"8con\" -fmax-errors=1 -Werror
